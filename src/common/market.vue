...
.shadow.darkMode {
  ...
  /deep/ .el-tabs--border-card {
    background-color: #373737;
    border: 1px solid rgba(#ffffff, 0.37);
    .el-tabs__header {
      background-color: rgba(#ffffff, 0.16);
      border-bottom: 1px solid rgba(#ffffff, 0.37);
      .el-tabs__item.is-active {
        background-color: rgba(#409eff, 0.6);
        color: rgba(#ffffff, 0.6);
        border-right-color: rgba(#ffffff, 0.37);
        border-left-color: rgba(#ffffff, 0.37);
      }
    }
  }
