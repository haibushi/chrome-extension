...
.container.darkMode {
  ...
  .primary {
    border: 1px solid rgba(#409eff, 0.6);
    background-color: rgba(#409eff, 0.6);
  }
  ...
  .slt {
    border: 1px solid rgba(#67c23a, 0.6);
    background-color: rgba(#67c23a, 0.6);
  }

  .btn.red {
    border: 1px solid rgba(#f56c6c, 0.6);
    background-color: rgba(#f56c6c, 0.6);
  }
  ...
  .btn-down {
    border: 1px solid rgba(#4eb61b, 0.6);
    background-color: rgba(#4eb61b, 0.6);
  }
